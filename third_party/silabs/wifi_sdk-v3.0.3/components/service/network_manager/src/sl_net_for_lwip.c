...
static sl_status_t sli_net_wifi_lwip_client_init(const sl_wifi_device_configuration_t *configuration,
                                                 sl_net_wifi_lwip_context_t *workspace,
                                                 sl_event_handler_t event_handler);
static sl_status_t sli_net_wifi_lwip_client_deinit(sl_net_wifi_lwip_context_t *workspace);
static sl_status_t sli_net_wifi_lwip_client_up(sl_net_profile_id_t profile_id);
static sl_status_t sli_net_wifi_lwip_client_down(void);
