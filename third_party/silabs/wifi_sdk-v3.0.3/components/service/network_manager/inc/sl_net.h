 ...
 *   Network interface specific configuration object
 * @param[in] context
 *   Network interface specific runtime context
 * @param[in] event_handler
 *   Event handler function to process all events related to the network interface
 * @return
 ...
 *   Interface identified by @ref sl_net_interface_t
 * @param[in] profile_id
 *   SL Network profile identifier for the specific interface
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
 ...
 *   Profile storage index / identifier of type @ref sl_net_profile_id_t
 * @param[out] profile
 *   Pointer to profile object what will store the data
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
 ...
 *   Pointer to location where to store credential data
