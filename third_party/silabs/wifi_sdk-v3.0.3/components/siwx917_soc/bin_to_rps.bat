...
cd %REPO_DIR%
cd %CONVERSION_TOOLS_DIR%
set CONVERSION_TOOLS_DIR=%CD%

cd %REPO_DIR%

copy /y "%PROJECT_DIR%\%PROJECT_NAME%.bin" "%CONVERSION_TOOLS_DIR%\%PROJECT_NAME%.bin"
...
objcopy.exe  -O binary desc.exe -j .secondb desc.bin
