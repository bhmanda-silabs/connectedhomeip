...
/*==============================================*/
/**
 * @fn           int RSI_SIO_UARTReadBlocking(volatile SIO_Type *pstcSio, void *data, int numBytes)
...
/*==============================================*/
/**
 * @fn           uint8_t RSI_SIO_UartInit(SIO_Type *pstcSio, stc_sio_uart_config_t *pstcConfig)
...
/*==============================================*/
/**
 * @fn           error_t RSI_SIO_I2cTransfer(volatile SIO_Type *pstcSio,stc_sio_i2c_config_t *pstcConfig,uint8_t u8SlaveAddr,uint8_t *u8PtrTxDat,uint16_t u16TxLen,uint8_t *u8PtrRxDat, uint16_t u16RxLen)
