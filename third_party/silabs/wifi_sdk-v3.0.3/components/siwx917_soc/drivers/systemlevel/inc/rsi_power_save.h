...
/**
 *@fn              STATIC INLINE void sl_si91x_disable_default_ldo_mode(void)
 *@brief           This API is used to disable the SOC LDO default mode
 *@return 	  none 
 */
STATIC INLINE void sl_si91x_disable_default_ldo_mode(void)
{
  PMU_SPI_MEM_MAP(0x1D6) &= ~(BIT(5));
}

/**
 *@fn              void sl_si91x_enable_bypass_ldo_rf(void)
 *@brief           This API is used to enable bypass of LDO-RF enable and control bits to control from outside
 *@return 	  none
 */
STATIC INLINE void sl_si91x_enable_bypass_ldo_rf(void)
{
...
/**
 *@fn              STATIC INLINE void sl_si91x_disable_flash_ldo(void)
 *@brief           This API is used to disable flash LDO.
 *@return 	  none
 */
STATIC INLINE void sl_si91x_disable_flash_ldo(void)
{
