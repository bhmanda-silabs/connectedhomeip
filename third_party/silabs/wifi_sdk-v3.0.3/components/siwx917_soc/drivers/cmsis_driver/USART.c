...
#if (RTE_USART_MODE)
  .pREGS = USART0, // USART ADDRESS
#else
  .pREGS = UART0, // UART ADDRESS
#endif
  .irq_num = USART0_IRQn, // IRQn
#if (RTE_USART0_CHNL_UDMA_TX_EN)
  .dma_tx = &USART0_UDMA_TX_CHNL,
#else
  .dma_tx = NULL,
#endif
#if (RTE_USART0_CHNL_UDMA_RX_EN)
  .dma_rx = &USART0_UDMA_RX_CHNL,
#else
  .dma_rx = NULL,
#endif
  .info = &USART0_Info,
...
static USART_RESOURCES UART1_Resources = {
  ...
  .pREGS = UART1,      // ADDRESS
  .irq_num = UART1_IRQn, // IRQn
#if (RTE_UART1_CHNL_UDMA_TX_EN == 1)
  .dma_tx = &UART1_UDMA_TX_CHNL,
#else
  .dma_tx = NULL,
#endif
#if (RTE_UART1_CHNL_UDMA_RX_EN == 1)
  .dma_rx = &UART1_UDMA_RX_CHNL,
#else
  .dma_rx = NULL,
#endif
  .info = &UART1_Info,
...
static USART_RESOURCES ULP_UART_Resources = {
  ...
  .pREGS = ULP_UART,        // ADDRESS
  .irq_num = ULPSS_UART_IRQn, // IRQn
#if (RTE_ULPUART_CHNL_UDMA_TX_EN == 1)
  .dma_tx = &ULPUART_UDMA_TX_CHNL,
#else
  .dma_tx = NULL,
#endif
#if (RTE_ULPUART_CHNL_UDMA_RX_EN == 1)
  .dma_rx = &ULPUART_UDMA_RX_CHNL,
#else
  .dma_rx = NULL,
#endif
  .info = &ULP_UART_Info,
