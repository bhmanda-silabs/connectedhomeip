 ...
 *   @ref sl_wifi_init should be called before this API.
 * @param[out] version
 *   @ref sl_wifi_version_string_t object that will contain the version string.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
 ...
 *   @ref sl_wifi_statistics_t object that contain wifi statistics
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
...
/***************************************************************************/ /**
 * @brief
 *   Get Wi-Fi interface MAC address
 * @pre 
 *   @ref sl_wifi_init should be called before this API.
 * @param[in] interface
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[out] mac
 *   @ref sl_mac_address_t object that will contain the MAC address of the interface.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
...
/***************************************************************************/ /**
 * @brief
 *   Set Wi-Fi interface MAC address
 * @param[in] interface
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[in] mac 
 ...
 *   A variable that will contain the current maximum transmit power in dBm.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 * @note
 ...
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[out] antenna
 *   @ref sl_wifi_antenna_t object that will contain the current antenna selection.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
 ...
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[out] channel
 *   @ref sl_wifi_channel_t object that will contain the current channel information.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
...
/***************************************************************************/ /**
 * @brief
 *   Sets Wi-Fi client interface listen interval
 * @pre 
 *   @ref sl_wifi_init should be called before this API.
 * @param[in] interface
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 ...
 *   2. Internally firmware maintains two tables : Worldwide table & Region based table. Worldwide table is populated by firmware with Max power values that chip can transmit that meets target specs like EVM. Region based table has default gain value set.
...
/***************************************************************************/ /**
 * @brief
 *   Waits for current scan to complete and stores results in the provided array.
 *   This function will also return once the scan result array is full, any further scan results will be lost.
...
/***************************************************************************/ /**
 * @brief
 *   Set/Load the certificate in to the device
 * @pre 
 *   @ref sl_wifi_init should be called before this API.
 ...
 *   If the new configuration modifies vital settings such as SSID or security the
 *   AP will be stopped and restarted automatically.
 * @param[in] interface
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[in] configuration
 *   Wi-Fi AP configuration. See @ref sl_wifi_ap_configuration_t
 ...
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[out] configuration
 *   @ref sl_wifi_ap_configuration_t object that will contain the AP configuration.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
...
/***************************************************************************/ /**
 * @brief
 *   Enables monitor (promiscuous/listening) mode on the Wi-Fi device.
...
/***************************************************************************/ /**
 * @brief
 *   Starts peer-to-peer (P2P) / Wi-Fi Direct discovery
 * @param[in] interface
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[in] configuration
...
/***************************************************************************/ /**
 * @brief
 *   Starts peer-to-peer (P2P) / Wi-Fi Direct connection
 * @param[in] interface
 *   Wi-Fi interface as identified by @ref sl_wifi_interface_t
 * @param[in] configuration
 *   P2P configuration as identified by @ref sl_wifi_p2p_configuration_t
 ...
 *   Period of time inserted between two packets in wireless transmission. Range : 0 - 3 (0 = 8us, 1 = 16us, 2 = 32us, 3 = 64us)
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 * @note
 *   sl_wifi_init should be called before this API and this API should be called before sl_wifi_connect.
 ******************************************************************************/
 ...
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
sl_status_t sl_wifi_11ax_config(uint8_t guard_interval);
