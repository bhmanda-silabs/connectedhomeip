...
/// Si91x region code
typedef enum { DEFAULT_REGION, US, EU, JP, WORLD_DOMAIN, KR, SG } sl_si91x_region_code_t;
/** @} */
...
typedef struct {
  uint16_t oper_mode;                  ///< operation mode, one of values from @ref sl_si91x_operation_mode_t
...
typedef struct {
  ...
  si91x_command_type_t command_type; ///< Si91x command type
