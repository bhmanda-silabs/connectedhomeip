 ...
 *                      Macros
 ******************************************************/
// This macro must be used while sending ping timeout in si91x_ping_request_t
...
sl_status_t sl_net_ping(sl_ip_address_t ip_address, uint16_t ping_size)
{
  sl_status_t status           = SL_STATUS_OK;
  si91x_ping_request_t request = { 0 };
