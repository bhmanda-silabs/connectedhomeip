...
/***************************************************************************/ /**
 * @brief
 *   Set Interface/Protocol specific TLS store configuration.
 * @pre 
 *   @ref sl_wifi_init should be called before this API.
 * @param[in] interface
...
/***************************************************************************/ /**
 * @brief
 *   Get Interface/Protocol specific TLS store configuration.
 * @pre 
 *   @ref sl_wifi_init should be called before this API.
 * @param[in] interface
 *   SL-NET interface as identified by @ref sl_net_interface_t.
...
/***************************************************************************/ /**
 * @brief
 *   Clear Interface/Protocol specific TLS store configuration.
 * @pre 
 *   @ref sl_wifi_init should be called before this API.
 * @param[in] interface
 *   SL-NET interface as identified by @ref sl_net_interface_t.
