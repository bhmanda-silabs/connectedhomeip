...
#define HTTP_SERVER_IP_ADDRESS "192.168.0.194"
//! HTTP resource name
#define HTTP_URL               "RS9116W.2.4.1.16.rps"
//! set HTTP hostname
#define HTTP_HOSTNAME          "192.168.0.194"
//! set HTTP extended header
//! if NULL , driver fills default extended header
#define HTTP_EXTENDED_HEADER   NULL
//! set HTTP hostname
...
void application_start(const void *unused)
{
  ...
  printf("\r\nStart Wi-Fi client interface success\r\n");
...
sl_status_t http_otaf_app()
{
  ...
  sl_wifi_set_callback(SL_WIFI_HTTP_OTA_FW_UPDATE_EVENT,
